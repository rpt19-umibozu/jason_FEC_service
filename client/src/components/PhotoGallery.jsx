    ...
    return (
      <div>
        <div className="photoContainer" style={{overflow: 'hidden', height:'440px', width:'49.89%', border: '1px solid #454545', backgroundColor:'#454545', float:'left', position: 'initial'}}>
          <img src={`${this.props.state.currentListing.photo1_a}`} className="innerPhoto" id="photo1" onClick={this.props.handlePhotoClick} style={{height:'100%', width:'100%', backgroundColor:'#454545', float:'left'}}/>
        </div>
        <div className="photoContainer" style={{overflow: 'hidden', height:'219px', width:'24.87%', border: '1px solid #454545', backgroundColor:'#454545', float:'left'}}>
          <img src={`${this.props.state.currentListing.photo2_b}`} className="innerPhoto" id="photo2" onClick={this.props.handlePhotoClick} style={{height:'100%', width:'100%', backgroundColor:'#454545', float:'left'}}/>
        </div>
        <div className="photoContainer" style={{overflow: 'hidden', height:'219px', width:'24.8%', border: '1px solid #454545', backgroundColor:'#454545', float:'left'}}>
          <img src={`${this.props.state.currentListing.photo4_b}`} className="innerPhoto" id="photo4" onClick={this.props.handlePhotoClick} style={{backgroundImage:`url(${this.props.state.currentListing.photo4_b})`, backgroundSize:'cover', backgroundRepeat:'no-repeat', height:'auto', width:'auto', backgroundColor:'#454545', float:'left'}}/>
        ...
        <div className="photoContainer" style={{overflow: 'hidden', height:'219px', width:'24.87%', border: '1px solid #454545', backgroundColor:'#454545', float:'left'}}>
          <img src={`${this.props.state.currentListing.photo3_b}`} className="innerPhoto" id="photo3" onClick={this.props.handlePhotoClick} style={{height:'100%', width:'100%', backgroundColor:'#454545', float:'left'}}/>
        </div>
        <div className="photoContainer" style={{overflow: 'hidden', height:'219px', width:'24.8%', border: '1px solid #454545', float:'left'}}>
          <img src={`${this.props.state.currentListing.photo5_b}`} className="innerPhoto" id="photo5" onClick={this.props.handlePhotoClick} style={{height:'100%', width:'100%', backgroundColor:'#454545', float:'left'}}/>
