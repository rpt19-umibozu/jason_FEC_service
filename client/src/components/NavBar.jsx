...
const NavBar = (props) => {
  return (
    <div style={{padding:'8px 0 10px 12px'}}>
      ...
      <input onKeyPress={props.handleSearchBar} placeholder ='Search' style={{padding:'18px 288px 15px 45px', borderRadius:'4px', border:'1px solid #EBEBEB', boxShadow:'0.5px 2px 5px rgb(0, 0, 0, 9.5%)', backgroundImage: 'url(https://fec-photos.s3-us-west-1.amazonaws.com/otherPics/searchlogo.jpg)', backgroundSize: '28.5px', backgroundPosition:'10px', backgroundRepeat:'no-repeat'}}/>
      </form>
      <div>
