...
const NavBar = (props) => {
  return (
    <div style={{padding:'8px 0 2px 20px'}}>
      ...
      <input onKeyPress={props.handleSearchBar} placeholder ='Search' style={{margin:'0 0 0 -1px', padding:'13.5px 228px 15px 49px', borderRadius:'4px', border:'1px solid #EBEBEB', boxShadow:'0.5px 2px 5px rgb(0, 0, 0, 8%)', backgroundImage: 'url(https://fec-photos.s3-us-west-1.amazonaws.com/otherPics/searchlogo.jpg)', backgroundSize: '28px', backgroundPosition:'12px 11px', backgroundRepeat:'no-repeat', outline: 'none', fontWeight: 'bold', fontSize: '1em', color: '#4d4c4c'}}/>
      </form>
      <div>
